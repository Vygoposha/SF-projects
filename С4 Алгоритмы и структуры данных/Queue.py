...
class Queue:
    ...
    def is_empty(self):
        return self.tail == self.head and self.tasks == 0
    ...
    def add(self):
        ...
        print(f'Задача номер {self.tasks[self.tail]} добавлена')

    def show(self):
        print(f'Задача номер {self.tasks[self.head]} в приоритете')

    def do(self):
        print(f'Задача номер {self.tasks[self.head]} выполнена')
